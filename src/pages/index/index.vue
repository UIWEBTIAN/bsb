  ...
  <div class="index">
    ...
    <div class="swiper">
      <swiper indicator-dots autoplay circular>
              <swiper-item>
                  <image mode="aspectFill" src="/static/image/1.jpg"></image>
              </swiper-item>
              <swiper-item>
                  <image mode="aspectFill" src="/static/image/2.jpg"></image>
              </swiper-item>
              <swiper-item>
                  <image mode="aspectFill" src="/static/image/3.jpg"></image>
              </swiper-item>
      </swiper>
    </div>
    <!-- 分类 -->
